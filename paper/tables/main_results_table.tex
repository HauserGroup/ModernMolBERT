\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{l r r r r r}
    ...
    \midrule
    \textbf{\model{}-small} & 79.6 & 83.7 & 64.8 & 73.2 & 77.3 \\
    \textbf{\model{}-base} & 80.7 & 83.8 & 64.4 & 70.7 & 77.4 \\
    \bottomrule
  \end{tabularx}
  \caption{%
    ...
    \emph{Overall} is the unweighted mean across completed benchmark datasets (25 for \model{}-small; 24 for \model{}-base,
    which lacks Tox21; see \cref{tab:pertask}).
