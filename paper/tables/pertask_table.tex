...
\begin{longtable}{l r r r r r r r r }
  ...
  HIV & 78.4 & 75.3 & 75.9 & 78.0 & 76.2 & 73.3 & 74.3 & 75.5 \\
  MUV & 72.4 & 56.6 & 57.7 & 79.8 & 74.0 & 72.1 & 69.3 & 72.6 \\
  SIDER & 67.4 & 61.6 & 56.6 & 66.6 & 64.7 & 64.3 & 63.5 & 66.0 \\
  Tox21 & 75.9 & 69.4 & 69.0 & 75.0 & 73.9 & 74.2 & 73.6 & 72.8 \\
  \addlinespace
  \bottomrule
  \caption{Per-task test ROC-AUC ($\times100$) for all models on the 25-task benchmark. \emph{MMB-s} = \model{}-small (standard), \emph{MMB-b} = \model{}-base, \emph{MMB-sp} = small span masking, \emph{MMB-h} = small hetero-span masking. All models are evaluated on the full set of 25 tasks.}\label{tab:pertask}
\end{longtable}
}
