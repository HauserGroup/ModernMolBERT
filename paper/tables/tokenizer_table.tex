...
\begin{table}[htbp]
  ...
  \begin{tabular}{l r}
    \toprule
    \textbf{Tokeniser property} & \textbf{Value} \\
    \midrule
  ...
  \end{tabular}
  \caption{%
    Summary statistics for the \selfies{}-adapted \ape{} tokeniser.
    ...
    631 tokens on which all model weights are initialised and trained.
    Sequence statistics and coverage are evaluated on 10\,000 held-out
    \chembl{}~36 molecules.
  }%
  \label{tab:tokeniser-stats}
\end{table}
